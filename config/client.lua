return {
    ...
    pauseMapText = 'Blackout Roleplay', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    hasKeys = function(plate, vehicle)
        ...
        return exports.mVehicle:HasKeyClient(vehicle)
    end,
}
